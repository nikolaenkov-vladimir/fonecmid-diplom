...
Процедура РассчитатьНДФЛ() 
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               ////Начало изменения: Задача: ONEC-MID-DIPLOM. Автор: Николаенков В.А. Дата: 01.10.2024 
	               //Было
	               //Начало вставки: Задача: ONEC-MID-DIPLOM. Автор: Николаенков В.А. Дата: 24.09.2024
	               //|ГДЕ
	               //|	ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.Регистратор В(&Разрез)
	               //Конец вставки
	               //Вставка:
	               |ГДЕ
	               |ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.Регистратор = &Регистратор
	               //Конец изменения
	               |СГРУППИРОВАТЬ ПО
	               ...
	               |	ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.Регистратор";
