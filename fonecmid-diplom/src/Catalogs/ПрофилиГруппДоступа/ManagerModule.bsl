...
Функция ЗаполненныеПоставляемыеПрофили()
	...
	//Начало вставки: Задача: ONEC-MID-DIPLOM. Автор: Николаенков В.А. Дата: 06.08.2024
	ОписаниеПрофиляСпециалист = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ЗаполнитьПрофильСпециалист(ОписаниеПрофиляСпециалист);
	ОписанияПрофилей.Добавить(ОписаниеПрофиляСпециалист);
	
	ОписаниеПрофиляМенеджер = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ЗаполнитьПрофильМенеджер(ОписаниеПрофиляМенеджер);
	ОписанияПрофилей.Добавить(ОписаниеПрофиляМенеджер);
	
	ОписаниеПрофиляБухгалтерИТФирмы = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ЗаполнитьПрофильБухгалтерИТФирмы(ОписаниеПрофиляБухгалтерИТФирмы);
	ОписанияПрофилей.Добавить(ОписаниеПрофиляБухгалтерИТФирмы);
	//Конец вставки
	...
	//Начало вставки: Задача: ONEC-MID-DIPLOM. Автор: Николаенков В.А. Дата: 06.08.2024
	ЗаполнитьПрофильСпециалист(ОписаниеПрофиляСпециалист, Истина);
	ЗаполнитьПрофильМенеджер(ОписаниеПрофиляМенеджер, Истина);
	ЗаполнитьПрофильБухгалтерИТФирмы(ОписаниеПрофиляБухгалтерИТФирмы, Истина);
	//Конец вставки
...
//Начало вставки: Задача: ONEC-MID-DIPLOM. Автор: Николаенков В.А. Дата: 06.08.2024
Процедура ЗаполнитьПрофильСпециалист(ОписаниеПрофиляСпециалист, КромеОписания = Ложь)
	
	Если КромеОписания Тогда
		Описание = ОписаниеПрофиляСпециалист.Описание;
	Иначе
		Описание =
			НСтр("ru = 'Предназначен для:
			           |- настройки параметров работы и обслуживания информационной системы,
	...
	ЗаполнитьЗначенияСвойств(ОписаниеПрофиляСпециалист,
		УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа());
	
	ОписаниеПрофиляСпециалист.Имя           = "Специалист";
	ОписаниеПрофиляСпециалист.Идентификатор = Новый УникальныйИдентификатор();
	ОписаниеПрофиляСпециалист.Наименование  = НСтр("ru = 'Специалист'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиляСпециалист.Роли.Добавить("ВКМ_ДобавлениеИзменениеОбслуживаниеКлиента");
	ОписаниеПрофиляСпециалист.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиляСпециалист.Роли.Добавить("ВКМ_РаботаСЗаявкамиКлиентов");
	ОписаниеПрофиляСпециалист.Описание = Описание;
	
КонецПроцедуры

Процедура ЗаполнитьПрофильБухгалтерИТФирмы(ОписаниеПрофиляБухгалтерИТФирмы, КромеОписания = Ложь)
	
	Если КромеОписания Тогда
		Описание = ОписаниеПрофиляБухгалтерИТФирмы.Описание;
	Иначе
		Описание =
			НСтр("ru = 'Предназначен для:
			           |- настройки параметров работы и обслуживания информационной системы,
	...
	ЗаполнитьЗначенияСвойств(ОписаниеПрофиляБухгалтерИТФирмы,
		УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа());
	
	ОписаниеПрофиляБухгалтерИТФирмы.Имя           = "БухгалтерИТФирмы";
	ОписаниеПрофиляБухгалтерИТФирмы.Идентификатор = Новый УникальныйИдентификатор();
	ОписаниеПрофиляБухгалтерИТФирмы.Наименование  = НСтр("ru = 'БухгалтерИТФирмы'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиляБухгалтерИТФирмы.Роли.Добавить("ВКМ_ИспользованиеОбработкиМассовоеСозданиеАктов");
	ОписаниеПрофиляБухгалтерИТФирмы.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиляБухгалтерИТФирмы.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументаРеализацияТоваровИУслуг");
	ОписаниеПрофиляБухгалтерИТФирмы.Описание = Описание;
	
КонецПроцедуры

Процедура ЗаполнитьПрофильМенеджер(ОписаниеПрофиляМенеджер, КромеОписания = Ложь)
	
	Если КромеОписания Тогда
		Описание = ОписаниеПрофиляМенеджер.Описание;
	Иначе
		Описание =
			НСтр("ru = 'Предназначен для:
			           |- настройки параметров работы и обслуживания информационной системы,
	...
	ЗаполнитьЗначенияСвойств(ОписаниеПрофиляМенеджер,
		УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа());
	
	ОписаниеПрофиляМенеджер.Имя           = "Менеджер";
	ОписаниеПрофиляМенеджер.Идентификатор = Новый УникальныйИдентификатор();
	ОписаниеПрофиляМенеджер.Наименование  = НСтр("ru = 'Менеджер'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиляМенеджер.Роли.Добавить("ВКМ_ДобавлениеИзменениеОбслуживаниеКлиента");
	ОписаниеПрофиляМенеджер.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиляМенеджер.Роли.Добавить("ВКМ_РаботаСЗаявкамиКлиентов");
	ОписаниеПрофиляМенеджер.Описание = Описание;
